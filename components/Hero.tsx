    ...
    <section className="relative min-h-screen flex items-center overflow-hidden">
      ...
      <div className="absolute inset-0 z-0">
        <Image
          ...
          priority
        />
        <div className="absolute inset-0 bg-knakke-darker/55" />
        <div className="absolute inset-0 bg-gradient-to-r from-knakke-darker/80 via-knakke-darker/50 to-transparent" />
        <div className="absolute inset-0 bg-gradient-to-t from-knakke-darker via-transparent to-knakke-darker/30" />
      </div>
